...
export default function Step03IPGenerate() {
  const { rfNodes, generateFromSelection, isGenerating } = useProject()
  ...
  return (
    <div className="space-y-4 py-1">
      ...
      <button
        ...
        className={cn(
          'w-full flex items-center justify-center gap-2 py-2.5 rounded-md text-[15px] font-medium transition-all',
      ...
      <div className="rounded-lg border border-line bg-canvas-800/30 p-2.5 space-y-1.5">
        <p className="text-[14px] font-mono text-neutral-600 uppercase tracking-wider mb-1">操作说明</p>
        {[
          ...
          <div key={num} className="flex items-start gap-2">
            <span className="text-[15px] font-mono text-neutral-700 shrink-0 mt-0.5">{num}</span>
